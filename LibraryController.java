...
import test_project.OptionPane;
...
public class LibraryController
{
	...
	boolean checkInputOnlyDigits(String inputString)
	{
		...
		{
			optionPane.showMessageDialog(null, "Incorrect characters only 0-9 are allowed", "Error", JOptionPane.ERROR_MESSAGE);
			return false;
		}
		...
		try
		{
			...
			{
				optionPane.showMessageDialog(null, "The number is too low, min is " + Integer.MIN_VALUE, "Error", JOptionPane.ERROR_MESSAGE);
				return false;
			}
		}
		catch(Exception e)
		{
			optionPane.showMessageDialog(null, "The number is too high or low, only this is allowed: " + Integer.MIN_VALUE + " - " +  Integer.MAX_VALUE, "Error", JOptionPane.ERROR_MESSAGE);
			return false;
		}	
	...
	public boolean loadBorrowedMedia()
	{
		try
		{
			Scanner theScanner = new Scanner(new File("src/Mediabiblioteket/files/Utlanade.txt"));
	...
	private boolean loadFileBorrowers()
	{
		try
		{
			...
			Scanner theScanner = new Scanner(new File("src/Mediabiblioteket/files/Lantagare.txt"));
			StringTokenizer theTokenizer;
	...
	private boolean loadFileMedia()
	{
		...
		{
			StringTokenizer theTokenizer;
			Scanner theScanner = new Scanner(new File("src/Mediabiblioteket/files/Media.txt"));
  ...
  public void setOptionPane(OptionPane n) { this.optionPane = n; }
}
